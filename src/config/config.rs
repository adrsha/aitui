...
pub struct KeybindConfig {
    ...
    #[serde(default = "kb_quit")]           pub quit: String,
    #[serde(default = "kb_next_session", alias = "session_next")]   pub next_session: String,
    #[serde(default = "kb_prev_session", alias = "session_prev")]   pub prev_session: String,
    #[serde(default = "kb_session_picker", alias = "open_session_picker")] pub session_picker: String,
    /// Fork the current session into a parallel branch.
    #[serde(default = "kb_fork_session", alias = "branch_session")] pub fork_session: String,
    /// Open the conversation in $EDITOR.
    #[serde(default = "kb_open_editor", alias = "open_transcript")]     pub open_editor: String,
    /// Open a file in $EDITOR (edited files first, then browse).
    #[serde(default = "kb_open_file", alias = "open_edit_picker")]       pub open_file: String,
    /// Drop into an interactive shell.
    #[serde(default = "kb_open_shell", alias = "open_terminal")]      pub open_shell: String,
    #[serde(default = "kb_file_picker", alias = "open_file_picker")]     pub file_picker: String,
    #[serde(default = "kb_model_picker", alias = "open_model_picker")]    pub model_picker: String,
    #[serde(default = "kb_next_model", alias = "model_next")]      pub next_model: String,
    #[serde(default = "kb_prev_model", alias = "model_prev")]      pub prev_model: String,
    #[serde(default = "kb_toggle_agent", alias = "toggle_agent_mode")]    pub toggle_agent: String,
    #[serde(default = "kb_redraw")]          pub redraw: String,
    #[serde(default = "kb_scroll_up")]       pub scroll_up: String,
    #[serde(default = "kb_scroll_down")]     pub scroll_down: String,
    #[serde(default = "kb_scroll_top")]      pub scroll_top: String,
    #[serde(default = "kb_scroll_bottom")]   pub scroll_bottom: String,
    /// Half-page scroll down / up the transcript (vim Ctrl-D / Ctrl-U).
    #[serde(default = "kb_scroll_half_down")] pub scroll_half_down: String,
    #[serde(default = "kb_scroll_half_up")]   pub scroll_half_up: String,
    /// Show / hide the full output of executed tools (collapsed by default).
    #[serde(default = "kb_toggle_output", alias = "toggle_tool_output")]   pub toggle_output: String,

    // ── Normal mode (input box) ────────────────────────────────────────────
    #[serde(default = "kb_insert", alias = "normal_insert", alias = "enter_insert")]  pub insert: String,
    #[serde(default = "kb_command", alias = "enter_command")] pub command: String,
    #[serde(default = "kb_palette", alias = "open_palette")] pub palette: String,
    #[serde(default = "kb_help", alias = "toggle_help")]    pub help: String,
    #[serde(default = "kb_submit", alias = "send_message")]  pub submit: String,
    #[serde(default = "kb_visual", alias = "enter_visual")]  pub visual: String,
    ...
    #[serde(default = "kb_normal", alias = "insert_to_normal", alias = "escape_insert")]  pub normal: String,
}

fn kb_quit() -> String { "ctrl-c".into() }
fn kb_next_session() -> String { "ctrl-n".into() }
fn kb_prev_session() -> String { "ctrl-p".into() }
fn kb_session_picker() -> String { "ctrl-s".into() }
fn kb_fork_session() -> String { "ctrl-y".into() }
fn kb_open_editor() -> String { "ctrl-o".into() }
fn kb_open_file() -> String { "ctrl-e".into() }
fn kb_open_shell() -> String { "ctrl-g".into() }
fn kb_file_picker() -> String { "ctrl-f".into() }
fn kb_model_picker() -> String { "ctrl-m".into() }
fn kb_next_model() -> String { "ctrl-]".into() }
fn kb_prev_model() -> String { "ctrl-[".into() }
fn kb_toggle_agent() -> String { "ctrl-a".into() }
fn kb_redraw() -> String { "ctrl-l".into() }
fn kb_scroll_up() -> String { "pageup".into() }
fn kb_scroll_down() -> String { "pagedown".into() }
fn kb_scroll_top() -> String { "ctrl-home".into() }
fn kb_scroll_bottom() -> String { "ctrl-end".into() }
fn kb_scroll_half_down() -> String { "ctrl-d".into() }
fn kb_scroll_half_up() -> String { "ctrl-u".into() }
fn kb_toggle_output() -> String { "ctrl-t".into() }
fn kb_insert() -> String { "i".into() }
fn kb_command() -> String { ":".into() }
fn kb_palette() -> String { "/".into() }
fn kb_help() -> String { "?".into() }
fn kb_submit() -> String { "enter".into() }
fn kb_visual() -> String { "v".into() }
fn kb_normal() -> String { "esc".into() }
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            // The endpoint/key may also be supplied via the AITUI_ENDPOINT and
            // AITUI_API_KEY environment variables (see `Config::load`).
            api: ApiConfig {
                endpoint: String::new(),
                api_key: String::new(),
